...
export const OMO_BUILTIN_AGENTS: OmoAgentDef[] = [
  {
    key: "build",
    display: "Build",
    descKey: "omo.agentDesc.build",
    tooltipKey: "omo.agentTooltip.build",
    recommended: "gpt-5.4",
    group: "main",
  },
  {
    key: "plan",
    display: "Plan",
    descKey: "omo.agentDesc.plan",
    tooltipKey: "omo.agentTooltip.plan",
  ...
  },
  {
    ...
    descKey: "omo.agentDesc.openCodeBuilder",
    tooltipKey: "omo.agentTooltip.openCodeBuilder",
    recommended: "gpt-5.4",
    group: "sub",
  },
  {
...
export const OMO_DISABLEABLE_COMMANDS = [
  { value: "init-deep", label: "init-deep" },
  { value: "ralph-loop", label: "ralph-loop" },
  { value: "ulw-loop", label: "ulw-loop" },
  { value: "cancel-ralph", label: "cancel-ralph" },
  { value: "refactor", label: "refactor" },
  { value: "start-work", label: "start-work" },
  { value: "stop-continuation", label: "stop-continuation" },
  { value: "remove-ai-slops", label: "remove-ai-slops" },
] as const;

export const OMO_DISABLEABLE_TOOLS = [
...
export const OMO_DISABLEABLE_SKILLS = [
  ...
  { value: "frontend-ui-ux", label: "frontend-ui-ux" },
  { value: "git-master", label: "git-master" },
  { value: "review-work", label: "review-work" },
  { value: "ai-slop-remover", label: "ai-slop-remover" },
] as const;
...
export const OMO_TMUX_PLACEHOLDER = `{
  "enabled": true,
...
export const OMO_WEBSEARCH_PLACEHOLDER = `{
  "provider": "exa"
}`;

export const OMO_RUNTIME_FALLBACK_PLACEHOLDER = `{
  "enabled": true,
...
export const OMO_COMMENT_CHECKER_PLACEHOLDER = `{
  "custom_prompt": ""
}`;

export const OMO_RALPH_LOOP_PLACEHOLDER = `{
  "enabled": false,
  "default_max_iterations": 100,
  "default_strategy": "continue"
}`;

export const OMO_MODEL_CAPABILITIES_PLACEHOLDER = `{
  "enabled": true,
...
export const OMO_BABYSITTING_PLACEHOLDER = `{
  "timeout_ms": 120000
}`;

export const OMO_GIT_MASTER_PLACEHOLDER = `{
  "commit_footer": true,
  "include_co_authored_by": true,
  "git_env_prefix": "GIT_MASTER=1"
}`;

export const OMO_START_WORK_PLACEHOLDER = `{
  "auto_commit": true
}`;

export const OMO_OPENCLAW_PLACEHOLDER = `{
  "enabled": false,
  "gateways": {},
  "hooks": {}
}`;
...
export const OMO_SLIM_COUNCIL_PLACEHOLDER = `{
  "enabled": true,
  "minVotes": 2
}`;

export const OMO_SLIM_MULTIPLEXER_PLACEHOLDER = `{
  "enabled": true,
  "maxConcurrent": 3
}`;

export const OMO_SLIM_TODO_CONTINUATION_PLACEHOLDER = `{
  "enabled": true
}`;

export const OMO_SLIM_FALLBACK_PLACEHOLDER = `{
  "enabled": true,
  "maxAttempts": 3
}`;
